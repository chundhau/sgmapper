                    ...
                    <tr key={c} className="d-flex">
                      ...
                      <td tabIndex="0">
                        ...
                        {coursesToDisplay[c].address}<br/><br/>
                            <a href={coursesToDisplay[c].website} target="_blank" className="btn btn-sm info-btn">
                                <FontAwesomeIcon icon="globe" />
                                &nbsp;Web
                            </a>
                            <a href={coursesToDisplay[c].mapsUrl} target="_blank" className="btn btn-sm info-btn">
                                <FontAwesomeIcon icon="map"/>
                                &nbsp;Map
                            </a>
                            <a href ={"tel:" + coursesToDisplay[c].phoneNumber} target="_blank" className="btn btn-sm info-btn">
